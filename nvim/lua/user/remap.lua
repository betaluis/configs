...
keymap('n', '<leader>h+', '<cmd>lua require("harpoon.ui").nav_file(1)<CR>')
keymap('n', '<leader>h[', '<cmd>lua require("harpoon.ui").nav_file(2)<CR>')
keymap('n', '<leader>h{', '<cmd>lua require("harpoon.ui").nav_file(3)<CR>')
